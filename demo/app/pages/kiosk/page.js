                                ...
                                <div className="comboSelections">
                                    ...
                                    <div className="itemsGrid">
                                        {menuItems["sides"]?.map((item, index) => {
                                            ...
                                            return (
                                                <div key={index} className={`menuItem ${comboSelections.side === item || comboSelections.entrees.includes(item) ? 'selected' : ''}`} onClick={() => handleComboItemSelect('side', item)}>
                                                    <div className="infoIcon" onClick={(e) => {
                                                        e.stopPropagation();
                                                        handleInfoClick(item);
                                                    }}>
                                    ...
                                    <div className="itemsGrid">
                                        {menuItems["entrees"]?.filter(item => {
                                            ...
                                            return (
                                                <div key={index} className={`menuItem ${comboSelections.side === item || comboSelections.entrees.includes(item) ? 'selected' : ''}`} onClick={() => handleComboItemSelect('entree', item)}>
                                                    <div className="infoIcon" onClick={(e) => {
                                                        e.stopPropagation();
                                                        handleInfoClick(item);
                                                    }}>
